      ...
      <div className={`${styles.container} ${navHeight ? styles.containerHeight : ''}`}>
        <div className={styles.wrapper}>
          ...
          <div className={`${styles.right} ${displayMenu ? styles.rightDisplay : ''}`}>
              <Link href='#quienes-somos' onClick={() => toggle()} style={{width: 'max-content'}}>Quiénes Somos</Link>
              <Link href='#agenda' onClick={() => toggle()}>Agenda</Link>
              <Link href='#servicios' onClick={() => toggle()}>Servicios</Link>
              <Link href='#nosotros' onClick={() => toggle()}>Nosotros</Link>
              <Link href='#experiencia' onClick={() => toggle()}>Experiencia</Link>
              <Link href='#equipo' onClick={() => toggle()}>Equipo</Link>
              <Link href='#contacto' onClick={() => toggle()}>Contacto</Link>
          </div>
        </div>
      </div>
    )
