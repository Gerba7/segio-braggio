        ...
        <div className={styles.wrapper}>
            <div className={styles.teamItem}>
                <div className={styles.imgContainer}>
                    <Image className={styles.img} src={Sergio_Braggio} width={250} height={250} alt='Sergio Braggio' />
                </div>
                <h2 className={styles.name}>SERGIO BRAGGIO</h2>
                <h3 style={{fontSize: '14px', color: '#ffffff'}}>DIRECTOR GENERAL</h3>
            </div>
            <div className={styles.team}>
                {team.map((t) => (
                    <div className={styles.teamItem} key={t.id}>
                        <div className={styles.imgContainer}>
                            <Image className={styles.img} src={t.img} width={250} height={250} alt={t.name} />
                        </div>
