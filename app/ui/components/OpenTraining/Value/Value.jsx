        ...
        <div className={styles.wrapper}>
            <div className={styles.serviceContainer}>
                <div className={styles.icon}>
                    <Image src={Presentation} width={40} height={40} alt='coaching' />
                </div>  
            ...
            <div className={styles.serviceContainer}>
                <div className={styles.icon}>
                    <Image src={World} width={40} height={40} alt='multinacional' />
                </div>
                <h3 className={styles.number}>+<Counter target={180} /></h3>
                <h5 className={styles.serviceTitle}>Capacitaciones en empresas multinacionales</h5>
            </div>
            <div className={styles.serviceContainer}>
                <div className={styles.icon}>
                    <Image src={Leadership} width={40} height={40} alt='Lideres' />
                </div>
            ...
            <div className={styles.serviceContainer}>
                <div className={styles.icon}>
                    <Image src={Conference} width={40} height={40} alt='Conferencias' />
                </div>
