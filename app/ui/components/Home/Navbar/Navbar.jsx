      ...
      <div className={`${styles.container} ${navHeight ? styles.containerHeight : ''}`}>
        <div className={styles.wrapper}>
          ...
          <div className={`${styles.right} ${displayMenu ? styles.rightDisplay : ''}`}>
              <Link href='#quienes-somos' onClick={() => toggle()} className={styles.link} style={{width: 'max-content', color: '#f5f5f5'}}>Quiénes Somos</Link>
              <Link href='#metodologia' onClick={() => toggle()} className={styles.link}>Metodología</Link>
              <Link href='#valor' onClick={() => toggle()} className={styles.link}>Valor</Link>
              <Link href='#contacto' onClick={() => toggle()} className={styles.link}>Contacto</Link>
          </div>
        </div>
      </div>
    )
