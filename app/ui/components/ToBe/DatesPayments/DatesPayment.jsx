        ...
        <div className={styles.left}>
          ...
          <div className={styles.item}>
            ...
            <div className={styles.texts}>
              <p className={styles.text}> Sábado, 26 de Julio 2025</p>
              <p className={styles.text}> Sábado, 13 de Septiembre 2025</p>
            </div>
          </div>
          <div className={styles.item}>
            <div className={styles.iconContainer}>
          ...
          <div className={styles.item}>
            ...
            <div className={styles.texts}>
              ...
              <p className={styles.text}>
                8 clases (8 Sábados consecutivos)
                16 horas
              </p>
            </div>
          </div>
          <div className={styles.item}>
            ...
            <div className={styles.texts}>
              ...
              <p className={styles.text}>
                10:00 AM - REP. DOM | PAR | MIA | CHI
              </p>
              <p className={styles.text}>
                09:00 AM - COL | PERÚ | ECU | PAN 
              </p>
              <p className={styles.text}>
                08:00 AM - C.RICA | NIC | SALV | HON | GUA | MEX
              </p>
            </div>
          </div>
        </div>
        <div className={styles.right}>
          <div className={styles.content}>
            ...
            <h4 className={styles.subSubtitle}>
              <span className={styles.price}>AL CONTADO: USD 240</span>   {/* <a href='https://cuanto.app/@abyagroup.org/p/5ee684' rel="noopener noreferrer" className={styles.suscriptionButton} aria-label="Link de pago una cuota">LINK DE PAGO</a> */}
              <span className={styles.price}>2 CUOTAS MENSUALES: USD 130</span> {/*  <a href='https://cuanto.app/@abyagroup.org/p/7b40da' rel="noopener noreferrer" className={styles.suscriptionButton} aria-label="Link de pago dos cuota">LINK DE PAGO</a> */}
            </h4>
            <h4 className={styles.subtitle}>PAGO EN PESOS (ARS)</h4>
            <h4 className={styles.subSubtitle}>
              <span className={styles.price}>AL CONTADO: $ 180.000 + IVA</span>   
              <span className={styles.price}>2 CUOTAS MENSUALES: $ 95.000</span>
            </h4>
