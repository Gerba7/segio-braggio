      ...
      <div className={`${styles.container} ${navHeight ? styles.containerHeight : ''}`}>
        <div className={styles.wrapper}>
          ...
          <div className={`${styles.right} ${displayMenu ? styles.rightDisplay : ''}`}>
              <Link href='#programa' onClick={() => toggle()} className={styles.link} style={{width: 'max-content', color: '#f5f5f5'}}>Programa</Link>
              <Link href='#modulos' onClick={() => toggle()} className={styles.link}>Módulos</Link>
              <Link href='#estructura' onClick={() => toggle()} className={styles.link}>Estructura</Link>
              <Link href='#inscripcion' onClick={() => toggle()} className={styles.link}>Inscripción</Link>
          </div>
        </div>
      </div>
    )
